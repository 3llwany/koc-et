...
@Component({
  selector: "app-financial-detailed-report",
  templateUrl: "./financial-detailed-report.component.html",
  styleUrls: ["./financial-detailed-report.component.css"],
})
export class FinancialDetailedReportComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.reportsService
      .getFinancialDetailsReportExcel<IFinancialModel, any>(obj)
      .subscribe((response) => {
        if (response) {
